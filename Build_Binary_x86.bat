...
SET INTEL_ENV=%ICPP_COMPILER15%bin\iclvars.bat
SET INTEL_ICL=%ICPP_COMPILER15%bin\ia32\icl.exe
IF "%OS_MODE%"==" Win64" SET INTEL_ICL=%ICPP_COMPILER15%bin\intel64\icl.exe
SET INTEL_TBB=%ICPP_COMPILER15%\tbb\include
IF "%OS_MODE%"==" Win64" SET INTEL_IPP=%ICPP_COMPILER15%redist\intel64\ipp
...
SET CUDA_HOST_COMPILER=%VS110COMNTOOLS%..\..\VC\bin
...
SET CMAKE_CONF_FLAGS=%CMAKE_CONF_FLAGS% -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=8.0 -DENABLE_WINRT_MODE:BOOL=TRUE -DNETFX_CORE:BOOL=TRUE -DWITH_VIDEOINPUT:BOOL=FALSE -DWITH_OPENEXR:BOOL=FALSE -DWITH_TIFF:BOOL=FALSE -DWITH_PNG:BOOL=FALSE -DWITH_WEBP:BOOL=FALSE -DWITH_WIN32UI:BOOL=FALSE -DWITH_VFW:BOOL=FALSE -DEMGU_CV_WITH_CVBLOB:BOOL=FALSE 
